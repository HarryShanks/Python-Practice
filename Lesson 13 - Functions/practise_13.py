...
This program helps to calculate the area and peremiter of a rectangle
"""

####### INSTRUCTIONS ########
# Complete the code by writing a function for calculating the peremiter, 
...
def calculate_peremiter():
    length = int(input("What is the length?"))
    width = int(input("What is the width?"))
    print(f"The peremiter is {((length + width) * 2)}.")
